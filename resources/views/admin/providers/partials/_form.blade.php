...
<div class="form-row">
    <div class="form-group col-lg-4 col-md-12">
        ...
        <select id="state_id" data-style="btn-white"
                class="form-control selectpicker show-tick" name="state_id"
...
<div class="btn-action">
    <button class="button button-blue-primary" type="submit" id="submit-btn">
             <span>
            {{ request()->is('admin/proveedores/crear') ? 'Guardar' : 'Actualizar' }}
        </span>
    </button>
