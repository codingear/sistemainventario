                ...
                <div class="card-body mb-2">
                    ...
                    <div class="form-row">
                        <div class="form-group col-lg-4 col-md-12">
                            ...
                            <input type="text" class="form-control" value="{{old('sale_price', $product->sale_price)}}"
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-lg-12 d-flex align-items-center justify-content-center">
                                        <div class="thumb mb-2">
                                            <img class="img-fluid" alt="180x180"
                                                src="https://dummyimage.com/200x180/000/aaa.png&text=Img+01">
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-sm-12 d-flex align-items-center justify-content-center">
                                        <div class="thumb mb-2">
                                            <img class="img-fluid" alt="180x180"
                                                src="https://dummyimage.com/180x160/000/aaa.png&text=Img+02">
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-sm-12 d-flex align-items-center justify-content-center">
                                        <div class="thumb mb-2">
                                            <img class="img-fluid" alt="180x180"
                                                src="https://dummyimage.com/180x160/000/aaa.png&text=Vista+Previa">
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-sm-12 d-flex align-items-center justify-content-center">
                                        <div class="thumb mb-2">
...
<script>
    $(document).ready(function () {
                ...
                function clearErrors() {
                    ...
                    {{--let myDropzone = Dropzone.options.productImages = {--}}
